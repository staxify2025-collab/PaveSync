...
''';
  ...
  static String _getLocalResponse(String message) {
    ...
    if (query.contains('paser') || query.contains('driving')) {
    ...
    if (query.contains('pci') || query.contains('astm d6433') || query.contains('aashto')) {
      return '**ASTM D6433 / AASHTO Pavement Condition Index (PCI) Summary:**\n'
          ...
          '- Identifies 19 distress types for asphalt and 19 for concrete.\n'
    ...
    if (query.contains('shoulder') || query.contains('dropoff')) {
    ...
    if (query.contains('striping') || query.contains('retroreflectivity') || query.contains('marking')) {
